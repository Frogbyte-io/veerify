  ...
  <NuxtLayout name="clean">
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8">
        <div>
          <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Better Auth Demo</h2>
          <p class="mt-2 text-center text-sm text-gray-600">Authentication powered by Better Auth</p>
        </div>
        ...
        <div v-if="session && session.data && session.data.user" class="bg-white p-6 rounded-lg shadow">
          <div class="text-center">
            ...
            <div class="mt-4 space-y-2">
              <p class="text-sm text-gray-600"><strong>Name:</strong> {{ session.data.user.name }}</p>
              <p class="text-sm text-gray-600"><strong>Email:</strong> {{ session.data.user.email }}</p>
              <p class="text-sm text-gray-600"><strong>ID:</strong> {{ session.data.user.id }}</p>
            </div>
            <div class="mt-6">
              <button
